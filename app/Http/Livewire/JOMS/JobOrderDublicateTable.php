...
class JobOrderDublicateTable extends Component
{
    ...
    {
        return view('livewire.j-o-m-s.job-order-dublicate-table', [
            'job_orders_duplicate' => TransactionSummary::where('wv_invoice_no', 'LIKE', '%WV%')
