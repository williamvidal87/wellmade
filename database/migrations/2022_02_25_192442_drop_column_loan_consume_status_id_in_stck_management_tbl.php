...
class DropColumnLoanConsumeStatusIdInStckManagementTbl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('stock_management', function (Blueprint $table) {
            $table->unsignedBigInteger('loan_consume_status_id')->nullable()->after('conversion_rate');
