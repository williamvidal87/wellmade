        ...
        <div class="col-xs-12">
            <div class="panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Duplicate Receipts</h3>
                </div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table id="jobtypeTable" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tbody>
                                @foreach ($job_orders_duplicate as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (Auth::user()->hasRole(['Encoder', 'Admin', 'Super Admin']))
                                                <button wire:click="export2PDF({{$data->jobOrder->id}})" class="btn btn-purple  m-1 btn-sm" {{ $this->checkAbleToPrint() && $data->jobOrder->printed_duplicate >= 1 ? 'disabled' : '' }}><i class="fa fa-print"></i>&nbsp;Print Reports</button>
                                            @endif
