        ...
        <form>
            ...
            <div class="modal-header">
                <div class="text-center">
                    <h4 class="modal-title">Dumaguete Plant</h4>
                    <h3 class="modal-title">INCENTIVE VOUCHER</h3>
                </div>
            ...
            <div class=" modal-body">
                <div class="center" style="width:50px;margin: auto;">
                    {!! DNS2D::getBarcodeHTML($token_scan, 'QRCODE', 2.5,2.5) !!}
                </div>
                <br>
                <div class="row">
                    ...
                    <table class="table table-bordered" style="font-size: 9px;">
                        <tr style="padding: 0; margin: 0;">
                            ...
                            <td style="width: 230px;">{{ $data->getContact->name ?? '' }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->getContact->address ?? '' }}</td>
                            <td style="font-weight:bold;">ID Num:</td>
                            <td>{{ $data->getContact->getClientType->getIndustry->name. '-'. $data->getContact->id  ?? '' }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->getContact->contact_no ?? '' }}</td>
                            <td style="font-weight:bold;">Assigned CSA:</td>
                            <td>{{ $data->getContact->getCsaType->csa_type ?? '' }}</td>
                        </tr>
                    </table>
                    <table class="table table-bordered" style="font-size: 9px;">
                        <tr>
                    ...
                    <table class="table table-bordered" style="font-size: 9px;">
                        ...
                        @foreach ($related_work_order as $key => $value)
                            ...
                            <tr>
                                ...
                                <td style="text-align:center; width: 45px;">
                                    @if ($key == 0)
                                        @if ($transaction_info->invoice_type_id == 1)
                                            {{ $transaction_info->sb_invoice_no }} 
                                        @elseif ($transaction_info->invoice_type_id == 2)
                                            {{ $transaction_info->wv_invoice_no }}
                                        @endif
                                    @else
                                        &nbsp;
                                    @endif
                                ...
                                @if ($value->er_work_group_id && $count_er == 0)
                                    ...
                                    <?php
                                        if(strstr($transaction_id, '-', true) == "OR"){
                                            $vat = 12;
                                        }else{
                                            $vat = 0;
                                        }
                            ...
                            <tr>
                                ...
                                <td style="text-align:center; width: 45px;">
                                    @if ($key == 0)
                                        {{ $transaction_info->sb_invoice_no ?? $transaction_info->wv_invoice_no ?? '' }}
                                    @else
                                        &nbsp;
                                    @endif
                                </td>
                    ...
                    <table class="table table-bordered" style="font-size: 9px;">
                        <tr>
                            <td>
                                @if ($data->getContact->image != null)
                                    <img src="storage/images/{{ $data->getContact->image}}" style="text-align:center; width: 180px; height: 100px !important;" alt="">
                                @endif
                            </td>
