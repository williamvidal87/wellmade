    ...
    <div class="modal-content">
        <form wire:submit.prevent="render" enctype="multipart/form-data">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Daily Maintenance Report</h4>
            ...
            <div class=" modal-body">
                <div class="form-group col-md-12 mt-5">
                    ...
                    <input class="col-md-8 p-3" type="date" wire:model.defer="start_date" id="month_ids"  value="{{ isset($start_d) ? $start_d : null }}">
                </div>
                <div class="form-group col-md-12 mt-5">
                    <label class="col-md-4" for="month_id">End Date:</label>
                    <input class="col-md-8 p-3" type="date" wire:model.defer="end_date" id="month_id"  value="{{ isset($end_d) ? $end_d : null }}">
                </div>            
