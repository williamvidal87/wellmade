                ...
                <div class="row">
                    <div class="col-lg-6 border-right">  
                        ...
                        <div class="form-group" wire:ignore>
                            ...
                            <select wire.ignore.self id="supplierId" wire:model.defer="supplier" name="supplier" style="width: 100%;" class="form-control" required>
                        ...
                        <div class="row">
                            <div class="col-lg-6"> 
                                <div class="form-group">
                                    <label>Qty</label>
                                    <input type="text"  wire:model.lazy="qty" name="qty" class="form-control" min="0" required>
                                    @if($errors->has('qty'))
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.lazy="acquisition_cost" name="acquisition_cost" class="form-control" style="text-align:right;" required>
                                    @if($errors->has('acquisition_cost'))
                                    <p style="color:red">{{$errors->first('acquisition_cost')}}</p>
                                    @endif
                                </div> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('loan_consume_ids'))
                            <p style="color:red">{{$errors->first('loan_consume_ids')}}</p>
                            @endif
                        </div>
                        <div class="form-group">
                            ...
                            @if ($item_image)
                                ...
                                <div class="d-flex">
                                    <img class="img-thumbnail" src="{{ $isUploaded ? $item_image->temporaryUrl() : url('storage/images/'. $item_image) }}" width="200" height="250">
                                </div>
                            @endif
                        </div> 
                    </div>
