...
<div class="panel-heading text-center">
    ...
    <h4 style="padding-top:0; padding-bottom:0; margin-top:3px; margin-bottom:3px; text-align:center">Engineering Sales Division</h4>
    <h4 style="padding-top:0; padding-bottom:0; margin-top:3px; margin-bottom:3px; text-align:center"  class="text-bold">Month-to-Month Complience Report</h4>     
    <p style="padding-top:0; padding-bottom:0; margin-top:0px; margin-bottom:3px; text-align:center; font-size: 12px"  class="text-bold">Report as of {{  '('. date('Y-m-d',strtotime(now())) .')'  }} </p>                 
</div>                        
<br><br>           
<table width="100%" style="border: 1px solid black; font-size: 12px">
    <thead>
        <tr class="bg-dark">
            <th colspan="28" style="border: 1px solid black; text-align: left">ER</th>
        </tr>
        <tr class="bg-info">
            <th style="border: 1px solid black; width: 10%; text-align: left" colspan="2">{{ $year != null ? $year : '' }}</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">JAN</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">FEB</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">MAR</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">APR</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">MAY</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">JUN</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">JUL</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">AUG</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">SEP</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">OCT</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">NOV</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">DEC</th>
            <th style="border: 1px solid black; width: 7%; text-align: center" class="bg-warning" colspan="2">TOTAL</th>
        </tr>
    </thead>
    <tbody>                         
        ...
        <tr>    
            ...
            @foreach($monthly_complience as $data)                              
            @endforeach
                ...
                @php
                    switch ($key) {
                        ...
                        case '02':
                            if($value->getWorkOrder->job_type_id == 2 && $value->getWorkOrder->status == 4  && $value->getWorkOrder->work_order_start_id != null){
                                $feb_er_doing++;
                            }elseif($value->getWorkOrder->job_type_id == 2 && $value->getWorkOrder->status == 9 && $value->getWorkOrder->work_order_start_id != null && $value->getWorkOrder->work_order_end_id != null){
                                $feb_er_done++;
    ...
    <thead>
        <tr class="bg-dark">
            <th colspan="28" style="border: 1px solid black; text-align: left">MF</th>
        </tr>
        <tr class="bg-info">
            <th style="border: 1px solid black; width: 10%; text-align: left" colspan="2">{{  $year != null ? $year : ''  }}</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">JAN</th>
    ...
    <thead>
        <tr class="bg-dark">
            <th colspan="28" style="border: 1px solid black; text-align: left">CALIB</th>
        </tr>
        <tr class="bg-info">
            <th style="border: 1px solid black; width: 10%; text-align: left" colspan="2">{{  $year != null ? $year : '' }}</th>
            <th style="border: 1px solid black; width: 7%" colspan="2">JAN</th>
