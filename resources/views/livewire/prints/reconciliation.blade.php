...
?>
<h6 style="line-height: 20%; padding-top: 5px">Wellmade Dumaguete Plant</h6>
<h6 style="line-height: 20%">Job Order Daily Report {{ $start_d != null ? '('. date('Y-m-d', strtotime($start_d)) . ')' : '' }}</h6>    
<h6 style="line-height: 20%; margin-bottom: 0">OPERATION & FINANCE DAILY RECONCILIATION</h6>      
<p style="font-size: 8px; padding-top: 0; margin-top: 0; text-align: center"><i>*Cutoff time is 2:00pm everyday, any entry more than 2:00pm is carried over to the next working day.</i></p>      

<div style="border-right: solid 1px black">
    <table width="100%" style="align-text: center;">                             
        <thead>
            <tr>
                <th rowspan="3"  style="line-height: 0.9 ">Timestamp:</th>
                <th rowspan="3"  style="line-height:   1 ">Reference SI/SO/DHI /PR/GR</th>
                <th rowspan="3"  style="line-height: 0.9 ">Customer</th>
                <th rowspan="3"  style="line-height:   1 ">J.O. No. SO/SI</th>
                <th rowspan="3"  style="line-height: 0.9 ">JOCN</th>
                <th colspan="4"  style="line-height: 0.9 " >Collection Received for the Day</th>
                <th rowspan="3"  style="line-height: 0.9 ">Incentives</th>
                <th rowspan="3"  style="line-height: 0.9 ">CSR</th>
                <th rowspan="3"  style="line-height: 0.9 ">Receivables/Remarks</th>                                              
            </tr>
            <tr>
                <th  style="line-height: 0.9" colspan="2">Operations</th>
                <th  style="line-height: 0.9" colspan="2">Finance</th>
            </tr>
            <tr >
            ...
            @foreach($transaction_particulars as $datas)
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td style="line-height: 0.9">{{$data->transactionSummaryInvoice->jobOrder->getClient->name ?? ''}}</td>                                               
                        <td style="line-height: 0.9">
                        ...
                        <td style="line-height: 0.9;; text-align: right; text-align: right;">
                            @if ($data->transactionSummaryReceipt->getCollect->type == "Finance")
                                @if ($data->transactionSummaryReceipt->getPaymentType->type == "Cheque")
                                    {{ number_format($data->transactionSummaryInvoice->jobOrder->overall_total, 2) }}
                                    <?php
        ...
        <thead>
            <tr>
                <th style="line-height: 0.9; text-align: right; padding-right: 2px" colspan="7">Unincluded Incentive:</th>  
                <th style="line-height: 0.9; border-top: 1px solid black" colspan='5'></th>                                           
            </tr>
        </thead>    
        <tbody>
            <tr>
                <td style="line-height: 0.9; border-bottom: hidden; padding-top:3px; padding-bottom: 5px" >Certified By:</td>
                <td style="line-height: 0.9; border-bottom: hidden; padding-top:3px; padding-bottom: 5px" >Audited By:</td>
            ...
            <tr>                                               
                <td style="line-height: 0.9; padding-top:6px; border-top: hidden">Plant Admin</td>
                <td style="line-height: 0.9; padding-top:6px; border-top: hidden">Finance</td>
        ...
        <thead>
            ...
            <tr>
                <th style="line-height: 0.9" rowspan="2">Timestamp:</th>
                <th style="line-height:   1" rowspan="2">Job Order No.</th>
                <th style="line-height: 0.9" colspan="2" rowspan="2">Customer</th>                                             
                <th style="line-height: 0.9" rowspan="2">CSA</th>
                <th style="line-height: 0.9; text-align:center" colspan="5">JOB ORDERS</th>
                <th style="line-height: 0.9; text-align:center" colspan="2" rowspan="2">Remarks</th>                                               
            </tr>
            <tr>
                <th style="line-height: 1">Date Start:</th>
                <th style="line-height: 1">Date Commit:</th>
                <th style="line-height: 1">Cost Center:</th>
                <th style="line-height: 1">On-Going</th>
                <th style="line-height: 1">Received:</th>                     
            </tr>
        </thead> 
        <tbody>
            <?php
            ...
            <tr>
                ...
                <td style="line-height: 0.9" colspan="2">{{$data->getClient->name ?? ''}}</td>
...
<div style="border-right: solid 1px black">
    <table width="100%" style="align-text: center;">            
        <thead>
            <tr>
                <th colspan="6" style="line-height: 0.9">Completed Transactions Waiting For SO Processing</th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($data->client_id != null)
                    <td style="line-height: 0.9">{{$data->getClient->name ?? ''}}</td>
                @else
                    <td style="line-height: 0.9">{{$data->getClient->name ?? ''}}</td>
                @endif                                              
            ...
            <tr>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 20px">Total Cash Fund:</td>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 20px">Cash in Box:</td>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 20px">Expenses for tde day:</td>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 20px">Total Cash & Expenses:</td>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 20px">Net Petty Cash:</td>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 20px">Cash Short or Over:</td>
            </tr>
            <tr>
                {{-- <td colspan="7" style="line-height: 0.9; text-align:center">isong</td> --}}
            </tr>
            <tr>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 25px">Net Remitted:</td>
                <td rowspan="2" style="line-height: 0.9; text-align:center; padding-bottom: 25px">Cash Remitted:</td>
                <td rowspan="2"style="line-height: 0.9; text-align:center; padding-bottom: 25px">Total Petty Cash Replenished:</td>
                <td colspan="3"style="line-height: 0.9; text-align:center; padding-bottom: 5px; text-align: center;">Petty Cash Per Cost Center</td>                                               
            </tr>
            <tr>
                <td style="line-height: 0.9; text-align:center; padding-bottom: 15px">Operations:</td>
                <td style="line-height: 0.9; text-align:center;padding-bottom: 15px">Warehouse:</td>
                <td style="line-height: 0.9; text-align:center;padding-bottom: 15px">Incentive:</td>
            </tr>                                        
        </tbody>
