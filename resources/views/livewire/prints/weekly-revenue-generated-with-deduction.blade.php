    ...
    <div class="col-xs-12">
        <div class="panel">
            <div class="panel-heading text-center">
                ...
                <h4 style="padding-top:0; padding-bottom:0; margin-top:3px; margin-bottom:3px; text-align:center"> {{$startDate != null ? date('Y-m-d',strtotime($startDate)) : now()->firstOfMonth()->format("Y-m-d")}} - {{$endDate != null ? date('Y-m-d',strtotime($endDate)) :  now()->format("Y-m-d")}}</h4>
                    ...
                    <table cellspacing="0" width="100%" style="font-size: 12px" >
                        <thead>
                            <tr class="bg-trans-dark">
                                <th rowspan="2" style="text-align:center; border: 0.5px solid black">Date</th>
                                <th rowspan="2" style="text-align:center; border: 0.5px solid black">Parts Total</th>
                                <th rowspan="2" style="text-align:center; border: 0.5px solid black">ER Total</th>
                                <th colspan="3" style="text-align:center; border: 0.5px solid black">Grinding</th>
                                <th colspan="3" style="text-align:center; border: 0.5px solid black">Boring/Horing</th>
                                <th colspan="2" style="text-align:center; border: 0.5px solid black">Refacing</th>
                                <th colspan="2" style="text-align:center; border: 0.5px solid black">Engine Rebuild</th>
                                <th rowspan="2" style="text-align:center; border: 0.5px solid black">MF Total</th>
                                <th colspan="7" style="text-align:center; border: 0.5px solid black">Machining</th>
                                <th colspan="2" style="text-align:center; border: 0.5px solid black">SP</th>
                                <th rowspan="2" style="text-align:center; border: 0.5px solid black">Calib Total</th>
                                <th colspan="3" style="text-align:center; border: 0.5px solid black">Calibration</th>
                            </tr>   
                            <tr class="bg-trans-dark">
                                <th style="text-align:center; border: 0.5px solid black">Cshaft</th>
                                <th style="text-align:center; border: 0.5px solid black">Surface</th>
                                <th style="text-align:center; border: 0.5px solid black">Valve</th>
                                <th style="text-align:center; border: 0.5px solid black">Liners</th>
                                <th style="text-align:center; border: 0.5px solid black">Mhouse</th>
                                <th style="text-align:center; border: 0.5px solid black">Conrod</th>
                                <th style="text-align:center; border: 0.5px solid black">Vseat</th>
                                <th style="text-align:center; border: 0.5px solid black">Lathe</th>
                                <th style="text-align:center; border: 0.5px solid black">Tig</th>
                                <th style="text-align:center; border: 0.5px solid black">Labor</th>
                                <th style="text-align:center; border: 0.5px solid black">Lathe</th>
                                <th style="text-align:center; border: 0.5px solid black">Weld</th>
                                <th style="text-align:center; border: 0.5px solid black">Mill</th>
                                <th style="text-align:center; border: 0.5px solid black">Shaper</th>
                                <th style="text-align:center; border: 0.5px solid black">Bal</th>
                                <th style="text-align:center; border: 0.5px solid black">Labor</th>
                                <th style="text-align:center; border: 0.5px solid black">Bmill</th>
                                <th style="text-align:center; border: 0.5px solid black">Bore</th>
                                <th style="text-align:center; border: 0.5px solid black">KMill</th>
                                <th style="text-align:center; border: 0.5px solid black">Pump</th>
                                <th style="text-align:center; border: 0.5px solid black">Inject</th>
                                <th style="text-align:center; border: 0.5px solid black">Cparts</th>
                            </tr>                           
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align:center; border: 0.5px solid black">{{ $key }}</td>
                            @php
                                $er_total = 0;
                                $cshaft = 0;
                                $er_cs_labor = 0;
                            ...
                            @endforeach
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($partTotal) }}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_total) ?? 0 }}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($cshaft) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($all_er_surface) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_valve) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_liners) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_mhouse) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_conrod) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_vseat) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($all_er_lathe) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ 0 }}</td> <!--not exist-->
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($all_er_labor) ?? 0 }}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_total) ?? 0 }}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_lathe) ?? 0 }}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_weld) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_mill) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_shaper) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_bal) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_labor) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_bmill) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_bore) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_kmill) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($calibTotal) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($calib_inject) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($calib_pump) ?? 0}}</td>
                                <td style="text-align:right; border: 0.5px solid black">0</td> <!--not exist-->
                            ...
                            @endforeach
                            <tr>                                 
                                <td style="font-weight: bold; text-align:center; border: 0.5px solid black; "> Grand Total: </td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_parts_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_cshaft_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_surface_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_valve_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_liners_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_mhouse_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_conrod_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_vseat_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_lathe_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">0</td><!--not exist-->
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($er_labor_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_lathe_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_weld_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_mill_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_shaper_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_bal_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_labor_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_bmill_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_bore_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($mf_kmill_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($calib_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($calib_inject_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black; border-right: hidden">{{ number_format($calib_pump_grand_total) ?? 0}}</td>
                                <td style="font-weight: bold; text-align:right; border: 0.5px solid black">0</td> <!--not exist-->
                            </tr>
                        </tbody>      
                   </table>  
                </div>    
