        ...
        @foreach ($report_data as $data)
            <form enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 pull-right">
                            <div class="form-group">
                                ...
                                <input  type="text" value="{{ $data->jobOrder->clientProfile->name }}" name="customer_name" class="form-control" required readonly>
                ...
                <div class="modal-footer">
                    ...
                    @endif
                    @if ($transaction_status == 2 && $serviceInvoiceId != null)
                        <button wire:click.prevent="transactionConfirmServiceInvoice({{ $serviceInvoiceId }}, 'reversed')" class="btn btn-info delete-header m-1 btn-sm pull-left"  title="Reverse"><i class="fa fa-history" aria-hidden="true"></i>&nbsp; Reverse</button> 
                    @elseif ($transaction_status == 3 && $serviceInvoiceId != null)
                        <button wire:click="transactionConfirmServiceInvoice({{ $serviceInvoiceId }})" class="btn btn-danger delete-header m-1 btn-sm pull-left"  title="Reversed" {{$transaction_status == 3 ? 'disabled' : ''}}><i class="fa fa-history" aria-hidden="true"></i>&nbsp; Reversed</button>
                    @endif
                </div>
            </form>
        @endforeach
