<div>
        ...
        <div class="col-xs-12">
            <div class="panel">
                <div class="panel-heading text-center">
                    <h5 style="padding-top:20px; padding-bottom:0; margin-bottom:3px">Dumaguete Wellmade Venture Inc. - Dumaguete Plant</h5>   
                    <h4 style="padding-top:0; padding-bottom:0; margin-top:3px; margin-bottom:3px" class="text-bold">
                    ...
                    <h4 style="padding-top:0; padding-bottom:0; margin-top:3px; margin-bottom:0"  class="text-bold">For the month of {{ $start_d != null ? '('. date('M Y', strtotime($start_d)) . ')' : '('. date('M Y',strtotime(now())) . ')' }}</h4>                    
                    <p style="padding-top:0; padding-bottom:0; margin-top:0px; margin-bottom:3px; font-size: 12px"  class="text-bold">Report as of {{ isset($start_d) ? date('Y-m-d') : date('Y-m-d') }} {{ $start_d != null ?  'by'. ' ' .auth()->user()->name  :  'by'. ' ' .auth()->user()->name  }} </p>    
                </div>
                <br><br>                    
                <br>               
                <!--Data Table-->                           
                ...
                <div class="panel-body">      
                    ...
                    <div class="table-responsive">
                        ...
                        <table  cellspacing="0" width="100%"> 
                            <thead>
                                <tr class="h4">
                                    <th style="text-decoration: underline" >Individual Month-End Report on Production:</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="h5">
                                ...
                                <tr class="h5">
                                    <?php
                                        ...
                                        for ($i = 1; $i <= $day_count; $i++) {
                                            ...
                                            }//make sure the holidays is not empty else wont work it will return zero workingdays ok? good!                                                                                  
                                        }
            ...
            <!-- The Generate Modal -->
            <div wire.ignore.self class="modal fade" id="operatorMonthlyEffeciencyReportModal" tabindex="-1" role="dialog" 
            aria-labelledby="operatorMonthlyEffeciencyReportModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" style="width: 450px" role="document">
                   @include('livewire.report.operator-monthly-efficiency-report-form')
                </div>
            </div>
        </div>
    </div>
    ...
    @section('custom_script')
        @include('layouts.scripts.operator-monthly-efficiency-report');
    @endsection