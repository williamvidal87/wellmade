<div>
    <div>
            ...
            <div class="col-xs-12">
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Incentive Types </h3>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="incentiveTypeTable" class="table table-striped table-bordered" cellspacing="0" width="100%"> 
                                <thead>
                                    <tr>
                                        <th>Incentive Types</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <!-- The Modal -->
                <div wire.ignore.self class="modal fade" id="incentiveTypeModal" tabindex="-1" role="dialog"
                 aria-labelledby="incentiveTypeModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog" role="document">
                        <livewire:workload.incentive-type-form/>
                    </div>
                </div>               
        ...
        @section('custom_script')
            @include('layouts.scripts.incentive-type-scripts'); 
        @endsection
</div>
