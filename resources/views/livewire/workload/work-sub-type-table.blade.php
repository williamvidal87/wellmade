        ...
        <div class="col-xs-12">
            <div class="panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Work Sub Type </h3>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table id="workSubTypeTable" class="table table-striped table-bordered" cellspacing="0"
                            width="100%">
                            <thead>
                                <tr>
                                    <th>Job Type</th>
            ...
            <div wire.ignore.self class="modal fade" id="workSubTypeModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <livewire:workload.work-sub-type-form />
                </div>
            </div>
...
@section('custom_script')
    @include('layouts.scripts.work-sub-type-scripts');
@endsection
