    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table id="statusTable" class="table table-striped table-bordered" cellspacing="0"
                            width="100%">
                            <thead>
                                <tr>
                                    <th>Status</th>
            ...
            <div wire.ignore.self class="modal fade" id="statusModal" tabindex="-1" role="dialog"
                aria-labelledby="statusModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" role="document">
                    <livewire:others.status-form />
                </div>
            </div>
