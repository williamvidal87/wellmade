    ...
    <div wire:ignore.self class="modal-content"> 
        <form wire:submit.prevent="store" enctype="multipart/form-data">
            ...
            <div class="modal-header">
                <h4 class="modal-title">ER Work Order</h4>
                ...
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <div class="panel-control">
                            <ul class="nav nav-tabs">
                                <li class="active" wire:ignore><a href="#detailsER" data-toggle="tab"
                                        aria-expanded="false">Details</a></li>
                                <li class="" wire:ignore><a href="#toolsER" data-toggle="tab" aria-expanded="true">Tools
                                        and Equipments</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div wire:ignore.self class="tab-pane fade active in" id="detailsER">
                                <div class="row">
                                    <div class="col-md-6" wire.ignore>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right" for="reference_no_id">Job Order no:</label>
                                            <div class="col-sm-8">
                                                <input type="text" wire:model.defer="reference_no_id"
                                                    name="reference_no_id" class="form-control" id="reference_no_id"
                                                    readonly>
                                            </div>
                                        ...
                                        <br><br>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right" for="er_work_group_id">ER Work Group:</label>
                                            <div class="col-sm-8">
                                                <select name="er_work_group_id" wire:model="er_work_group_id"
                                                    class="form-control select_design" id="er_work_group_id" required>
                                                    <option value=''>Choose ER Work Group</option>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="scopes_id">Scope Of Work:</label>
                                            <div class="col-sm-8">
                                                <div class="col-sm-10">
                                                    <select name="scopes_id" wire:model="scopes_id" 
                                                        wire:change.prevent="populateGeneralProcedure($event.target.value)"
                                                        class="form-control select_design" id="scopes_id">
                                                        <option value=''>Choose Scope Of Work</option>
                                                        @foreach($scopes as $data)
                                                            @if($data->er_work_group_id == $er_work_group_id)
                                                            <option value="{{ $data->id }}">{{ $data->scope_name}}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-2">
                                                    <button class="btn btn-primary pl-4"
                                                        wire:click.prevent="AddSubType">Add</button>
                                                </div>
                                            </div>
                                            @if($errors->has('scopes_id'))
                                            <p style="color:red">{{$errors->first('scopes_id')}}</p>
                                            @endif
                                        </div>
                                        <br><br>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="specification_id">Specification:</label>
                                            <div class="col-sm-8">
                                                <select name="specification_id" wire:model.defer="specification_id"
                                                    class="form-control select_design" id="specification_select">
                                                    <option value=''>None</option>
                                                    @foreach($specification as $data)
                                                    <option value="{{ $data->id }}">{{ $data->specification_name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @if($errors->has('specification_id'))
                                            <p style="color:red">{{$errors->first('specification_id')}}</p>
                                            @endif
                                        </div><br><br>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="general_procedure_id">General Procedure:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" wire:model.defer="general_procedure" name="general_procedure"></input>
                                            </div>
                                        ...
                                        <br><br>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right" for="er_work_sub_type_id">Work Sub Type:</label>
                                            <div class="col-sm-8">
                                                <select name="er_work_sub_type_id" wire:model.defer="er_work_sub_type_id"
                                                    class="form-control select_design" id="er_work_sub_type_id" required>
                                                    <option value=''>Choose Work Sub Type</option>
                                                    @foreach($processsubgroup as $data)
                                                    @if($data->group_id==$er_work_group_id && !empty($er_work_group_id))
                                                    <option value="{{ $data->id }}">{{ $data->sub_group}}</option>
                                                    @endif
                                                    @endforeach
                                                </select>
                                            </div>
                                            @if($errors->has('er_work_sub_type_id'))
                                            <p style="color:red">{{$errors->first('er_work_sub_type_id')}}</p>
                                            @endif
                                        </div><br><br>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="machine_id">Machine:</label>
                                            <div class="col-sm-8">
                                                <select name="machine_id" wire:model.defer="machine_id"
                                                    class="form-control select_design" id="machine_id">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="scope_description">Other Description:</label>
                                            <div class="col-sm-8">
                                                <input type="text" wire:model.defer="scope_description"
                                                    name="scope_description" class="form-control" id="scope_description">
                                            </div>
                                    ...
                                    <div class="col-md-6 border border-info" style="border-style: dashed">
                                        <div class="form-group pt-4">
                                            <label class="col-sm-4 control-label text-right"
                                                for="parts_required_id">Parts Required?:</label>
                                            <div class="col-sm-8">
                                                <select name="parts_required_id" wire:model.defer="parts_required_id"
                                                    class="form-control select_design" id="parts_required_id" required>
                                                    <option value="" selected>Choose Parts Required</option>
                                                    @foreach($statuses as $data)
                                                    @if($data->id == 10 or $data->id == 11)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" step="any" wire:model.defer="hours" name="hours"
                                                    class="form-control" id="hours" required style="width: 10rem">
                                            </div>
                                            @if($errors->has('hours'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" wire:model="qty" name="qty"
                                                    class="form-control" id="qty" required style="width: 10rem" wire:change="change">
                                            </div>
                                            @if($errors->has('qty'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" step="any" wire:model="price" wire:change="change" name="price" class="form-control" id="price" required style="width: 10rem" <?php
                                                    if($this->check_price_read==39||$this->check_price_read==41||$this->check_price_read==49||$this->check_price_read==51){
                                                    }
                                                    else{
                                                        echo "readonly";
                                                    }
                                        ...
                                        <br><br>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right" for="amount_increase">Amnt.Increase:</label>
                                            <div class="col-sm-8">
                                                <input type="number" step="any" wire:model="amount_increase"
                                                    name="amount_increase" class="form-control" id="amount_increase"
                                                    required style="width: 10rem" wire:change="change">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="discount_id">Discount:</label>
                                            <div class="col-sm-2">
                                                <select name="discount_id" wire:model.defer="discount_id"
                                                    class="form-control select_design" id="discount_id" required
                                                    style="width: 7rem">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" max="{{ $this->display_max_discount }}" step="any" wire:model="max_discount" name="max_discount"
                                                    class="form-control" id="max_discount" required style="width: 7rem" wire:change="change">
                                            </div>
                                            <label class="col-sm-4 control-label text-right"
                                                for="max_discount">MaxDiscount: {{ $this->display_max_discount }}%</label>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="incentive_type_id">Incentive Type:</label>
                                            <div class="col-sm-8">
                                                <select name="incentive_type_id" wire:model.defer="incentive_type_id"
                                                    class="form-control select_design" id="incentive_type_id" required wire:change="change">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label text-right"
                                                for="incentive">Incentive:</label>
                                            <div class="col-sm-4">
                                                <input readonly type="text" wire:model="incentive" name="incentive"
                                                    class="form-control" id="incentive" required>
                                            </div>
                            ...
                            {{-- start tools --}}
                            <div wire:ignore.self class="tab-pane fade" id="toolsER">
