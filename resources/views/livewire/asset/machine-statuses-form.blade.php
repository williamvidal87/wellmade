                        ...
                        <div class="col-xs-12">
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="machine_status">Machine Status Name</label>
                                    <input type="text" wire:model="machine_status" name="machine_status" id="machine_status" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
